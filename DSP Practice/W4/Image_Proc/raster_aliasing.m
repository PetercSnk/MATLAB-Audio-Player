...
mov_pics = VideoWriter('aliasing_pics.avi','Uncompressed AVI');
mov_pics.FrameRate = 10;
open(mov_pics);
mov_specs = VideoWriter('aliasing_specs.avi','Uncompressed AVI');
mov_specs.FrameRate = 10;
open(mov_specs);
